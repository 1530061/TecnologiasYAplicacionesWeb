  ...
  $(function () {
    ...
    $("#table_pdf").DataTable( {
        ...
        buttons: [
        {
           extend: 'pdf',
           footer: true,
           title: 'pdf_report_'+today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+" "+today.getHours() + "-" + today.getMinutes(),
           exportOptions: {
                columns: [0,1,2]
            }
        },
        {
           extend: 'csv',
           footer: false,
           title: 'csv_report_'+today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+" "+today.getHours() + "-" + today.getMinutes(),
           exportOptions: {
                columns: [0,1,2]
            }
        ...
        {
           extend: 'excel',
           title: 'excel_report_'+today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+" "+today.getHours() + "-" + today.getMinutes(),
           footer: false,
           exportOptions: {
                columns: [0,1,2]
            }
